...
# -*- coding: utf-8 -*-
#
# Scope Harness documentation build configuration file, created by
# sphinx-quickstart on Thu May 21 14:08:23 2015.
#
...
htmlhelp_basename = 'ScopeHarnessdoc'
...
latex_documents = [
  ('index', 'ScopeHarness.tex', 'Scope Harness Documentation',
   'Canonical Ltd.', 'manual'),
]
...
man_pages = [
    ('index', 'scopeharness', 'Scope Harness Documentation',
     ['Canonical Ltd'], 1)
]
...
texinfo_documents = [
  ('index', 'ScopeHarness', 'Scope Harness Documentation',
   'Canonical Ltd.', 'ScopeHarness', 'One line description of project.',
   'Miscellaneous'),
]
