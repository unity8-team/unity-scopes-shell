...
public:
    ...
    MatchResult match(const std::vector<preview::PreviewWidget::List>& preview) const;

    void match(MatchResult& matchResult, const std::vector<preview::PreviewWidget::List>& preview) const;
